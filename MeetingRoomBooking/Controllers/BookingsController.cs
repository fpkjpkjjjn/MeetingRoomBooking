...
namespace MeetingRoomBooking.Controllers {
    ...
    public class BookingsController : ControllerBase {
        ...
        [HttpGet]
        public async Task<IActionResult> GetBookings([FromQuery] int? roomId,[FromQuery] DateTime? date,[FromQuery] int page = 1,[FromQuery] int pageSize = 10) {
            if(page < 1) 
                page = 1;
            ...
            var bookings = await query.OrderBy(b => b.StartTime).Skip((page - 1) * pageSize).Take(pageSize).Select(b => new BookingDto {
                    Id = b.Id,
                    RoomId = b.RoomId,
        ...
        public async Task<IActionResult> GetBooking(int id) {
            var booking = await _context.Bookings.Where(b => b.Id == id).Select(b => new BookingDto {
                    Id = b.Id,
                    RoomId = b.RoomId,
                    RoomName = b.Room!.Name,
                    UserName = b.UserName,
